...
var express 		= 	require("express"),
	...
	passport.use(new LocalStrategy(function(username, password, done)
	{
		...
		var sql = "SELECT *	FROM comentarios.users WHERE usuario = '"+username+"'"; //VARIABLE QUE GUARDARÁ LA SENTENCIA SQL...
		db.queryMysql(sql, function(err, response)
		{
			...
			//Ejemplo:
			var comparador = bcrypt.compareSync(password, response[0].clave)
			/*SIENDO:
			...
			*/
			...
			if (err || response.length === 0 || comparador === false)
			{
