...
var registroPost = function(req, res, next)
{
	...
	db.queryMysql(sql, function(err, response)
	{
        ...
        sql = "INSERT INTO users (nombre, usuario, 	clave, 	email, 	fecha)	VALUES	('"+data.nombre+"', '"+data.username+"', '"+password+"',	'"+data.correo+"', '"+data.fechaActual+"')";//VARIABLE QUE GUARDARÁ LA SENTENCIA SQL...
  			db.queryMysql(sql, function(err, response)
  			{
